$(function(){
	...
	function callbackFunction (resp) {
		if (resp.result === 'success') {
			$('label[for="newsletter-email"]').text(resp.msg);
		}else{
			$('label[for="newsletter-email"]').text('Address alredy exist. Thank you.');
		}
	}
	
	$('.newsletter-form').ajaxChimp({callback: callbackFunction});
